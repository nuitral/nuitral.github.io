...
const Box = () => {
	return (
		<>
			...
			<div className="mt-1rem mb-1rem">
				The Box border is neutral white by default. To define its color, simply use
			...
			<div className="mt-1rem mb-2rem">
				On hover, the component dynamically adjusts its styles:
				<p>

					- <b>Background Color</b>: Becomes 40% lighter than the original color, creating a brighter appearance.
					- <b>Text Color</b>: Becomes 30% darker than the original color, ensuring optimal contrast and readability
					against the
					lighter background.
				</p>
...
<NuitralBox success-300 title="Success 300 Box" description="This is a success-300 box" />`}
			...
			<NuitralBox primary title="Primary Box" description="This is a primary or primary-500 box" />
